...
#    anime_titles.append(title2.find('img').get('alt'))
    #print("______________________________")

#title3 = title2.find_all('img')
#print(title2.find('img').get('alt'))
...
def multi_page(n):
    ...
    for p in range(1, n+1):
        ...
        soup = BeautifulSoup(requests.get(new_url).text, 'html5lib')
